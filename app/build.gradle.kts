...
dependencies {
    ...
    //
    // Enabled decoders: aac, ac3, eac3, dca, truehd, mlp, mp2, mp3, flac, alac.
    ...
    // fallback the track got no renderer at all and played silent. aac was
    // dropped 2026-09-12 and RESTORED 2026-09-14 as well, which brings back the
    // original GH #45 fix: on the on-demand path the FFmpeg renderer claims
    // HE-AAC ahead of the hardware AAC decoders that throw on it. See
    // app/libs/README.md for the rationale and the reproducible build steps,
    // and the Patents section of README.md.
